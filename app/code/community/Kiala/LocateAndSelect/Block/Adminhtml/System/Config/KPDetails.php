...
class Kiala_LocateAndSelect_Block_Adminhtml_System_Config_KPDetails extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    ...
    protected function _prepareLayout() {
        $button = $this->getLayout()->createBlock('adminhtml/widget_button')
            ...
            'onclick' => 'return detailsControl.addItem()',
            'class' => 'add'
                ));
        ...
        if (!$this->getTemplate()) {
            $this->setTemplate('kiala/locateandselect/system/config/kpdetails.phtml');
        }
    ...
    public function getValues() {
        return unserialize(Mage::getStoreConfig('carriers/kiala/kp_details_url_parameters'));
    }
